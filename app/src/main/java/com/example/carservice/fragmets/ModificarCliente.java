...
public class ModificarCliente extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        codigo = (EditText)v.findViewById(R.id.editCodigocli);
       // usuario = (EditText) v.findViewById(R.id.txtUsuario3);
        nombre = (EditText) v.findViewById(R.id.editTextTextPersonName31);
        apellido = (EditText) v.findViewById(R.id.editTextTextPersonName32);
        telefono = (EditText) v.findViewById(R.id.editTextTextPersonName33);
        direccion = (EditText) v.findViewById(R.id.editTextTextPersonName35);
        dui = (EditText) v.findViewById(R.id.editTextTextPersonName29);
